#!bin/sh
./../cpp_version/bin-ccc-arm/ranger --file train_png_small_set --mask train_mask_png_small_set --depvarname CLOUD --treetype 1 --probability --ntree 10 --memmode 3 --maxdepth 18 --write --verbose --batch
