#!bin/sh
./../cpp_version/bin-ccc-arm/ranger --file train_png_test --mask train_mask_png_test --depvarname CLOUD --treetype 1 --probability --ntree 10 --memmode 3 --savemem --maxdepth 18 --write --verbose --batch
